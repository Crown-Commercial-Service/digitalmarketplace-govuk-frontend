...
🔧 Changes:
  ...
  - Update Banner text again to notify that DOS5 is closing [PR #733](https://github.com/Crown-Commercial-Service/digitalmarketplace-govuk-frontend/pull/733)

## 3.11.1

🔧 Changes:

  - Update Banner text again to notify that DOS6 and G-Cloud 13 are live [PR #726](https://github.com/Crown-Commercial-Service/digitalmarketplace-govuk-frontend/pull/726)
...
🔧 Changes:
  ...
  - Update Banner text to ask buyers to sign up with PPG, for DMP 1.0 [PR #690](https://github.com/Crown-Commercial-Service/digitalmarketplace-govuk-frontend/pull/690)
